# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-10-20 13:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbourhood_location', models.CharField(blank=True, choices=[('Nairobi', 'Nairobi'), ('Machakos', 'Machakos'), ('KItui', 'KItui'), ('Garissa', 'Garissa'), ('Mombasa', 'Mombasa'), ('Malindi', 'Malindi'), ('Kisumu', 'Kisumu'), ('Migori', 'Migori'), ('Kakamega', 'Kakamega'), ('Uasingishu', 'Uasingishu')], default=0, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbourhood_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhood', to='app.Neighbourhood')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('description', models.TextField()),
                ('neighbourhood', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhoodproject', to='app.Neighbourhood')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='app.Image')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='app.Project')),
